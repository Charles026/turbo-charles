      ...
      <div className="mx-auto px-4 sm:px-6 md:px-8" style={{ maxWidth: 1000 }}>
        ...
        <section className="mb-[70px] flex flex-col gap-[28px]">
          ...
          <div className="flex flex-col gap-[28px]">
            ...
            <Image src={ImageDSTokenDefine} alt="" style={{ width: '100%', height: 'auto' }} className="rounded-2xl" />

            <Image src={ImageDSToken} alt="" style={{ width: '100%', height: 'auto' }} className="rounded-2xl " />
            <Image src={ImageDSTokenNaming} alt="" style={{ width: '100%', height: 'auto' }} className="rounded-2xl" />
